...
namespace Trabalho_Laboratorio.Areas.Identity.Pages.Account.Manage
{
	...
	public class Pratos_FavoritosModel : PageModel
	{
		...
		public IQueryable<GuardarClientePratoFavorito> ListaPratosFavoritos { get; set; }
		...
		private async Task LoadAsync(IdentityUser user)
		{
			...
			ListaPratosFavoritos = _context.GuardarClientePratoFavorito.Include(x => x.IdClienteNavigation).Include(x => x.IdPratoNavigation).Include(x => x.IdClienteNavigation.IdClienteNavigation).Where(x => x.IdClienteNavigation.IdClienteNavigation.Username == Username);
		}
