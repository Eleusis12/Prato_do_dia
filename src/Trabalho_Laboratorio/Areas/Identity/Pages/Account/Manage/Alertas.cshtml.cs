...
namespace Trabalho_Laboratorio.Areas.Identity.Pages.Account.Manage
{
	...
	public class AlertasModel : PageModel
	{
		...
		public IQueryable<PalavrasChave> ListaPalavrasAlertar { get; set; }
		...
		private async Task LoadAsync(IdentityUser user)
		{
			...
			ListaPalavrasAlertar = _context.PalavrasChave.Include(x => x.IdUtilizadorNavigation).Where(x => x.IdUtilizadorNavigation.Username == Username);
		}
